...
class Num2WordsKZTest(TestCase):
    def test_to_cardinal(self):
        ...
        self.assertEqual(
            ...
            "minus yetti yuz sakson to'qqiz million yuz yigirma besh",
        )
        self.assertEqual(
    ...
    def test_to_currency(self):
        self.assertEqual(
            ...
            "yigirma besh so\'m, yigirma to\'rt tiyn",
        )
        self.assertEqual(
            num2words(1996.4, lang="uz", to="currency", currency="UZS"),
            "bir ming to\'qqiz yuz to\'qson olti so\'m, qirq tiyn",
        )
        self.assertEqual(
            num2words(632924.51, lang="uz", to="currency", currency="UZS"),
            "olti yuz o\'ttiz ikki ming to\'qqiz yz yigirma to\'rt so\'m, ellik bir tiyn",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "to\'qqiz yuz sakson yetti million olti yuz ellik to\'rt ming "
            "uch yuz yigirma bir so\'m, o\'n ikki tiyn",
        )
